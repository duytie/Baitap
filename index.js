const contentLetterSrart_actived = "mẹ hãy ấn vào hình quà nè mẹ 🥰🥰" //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc mừng sinh nhật mẹ yêu! Con chúc mẹ một ngày tràn đầy niềm vui và hạnh phúc. Chúc mẹ ngày càng khỏe mạnh bình an và có thể biến bì tiền giấy thành polyme nha 🥰🥰🥰" //Nội dung của bức thư
...
imgLetter.src = "./img/img1.png"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
